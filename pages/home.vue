<template>
  ...
  <html data-wf-domain="landing-page-d4c502.webflow.io" data-wf-page="60bdafd24f62e88953c977f4" data-wf-site="60bdafd24f62e8078ac977ef" data-wf-status="1">
    <head>
      <meta charset="utf-8">
      <title>Webflow Cloneable Startup Template</title>
      ...
      <meta content="Webflow Cloneable Startup Template" property="og:title">
      ...
      <meta content="Webflow Cloneable Startup Template" property="twitter:title">
          ...
          <div class="service-card-wrap">
            <div class="column">
              <div class="service-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60be114fb6d57c45061cdce4_google-classroom.svg" width="10" alt="" class="service-icon">
                <div class="card-content-wrap">
                  <h3 class="heading-3">Syncs with Google Classroom</h3>
                  <p class="paragraph-2">All your tasks from Google Classroom are automatically imported to your diary. No need to worry going back and forth just to see what&#x27;s up tomorrow.</p>
                </div>
              </div>
            </div>
            <div class="column">
      ...
      <div class="section-statistics">
        <div class="container">
          <div class="title-wrap">
            <p class="title">Everyone loves bdsm</p>
            <h3 class="heading-primary h3-centre">Over 600,000+ diary entries created</h3>
          </div>
          <div class="feature-number-wrap">
            <div class="statistic-circle-wrap">
              <div class="circle-div">
                <h4 class="counterup">9876</h4>
            ...
            <div class="statistic-circle-wrap">
              <div class="circle-div">
                ...
                <div class="title-capped">Countries</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="section-content">
        ...
        <div data-w-id="90ab7248-4f69-4895-ad60-e486565c4d6b" class="section-blog">
          <div class="container">
            <div class="content-wrap">
              <p class="title">1.</p>
              <h2 class="heading-primary">Logging in</h2>
            </div>
            <div class="title-wrap" />
            <div class="blog-article-wrap">
              <div class="column">
                <div class="blog-card">
                  <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea4be2f795723124984e3_login1.JPG" loading="lazy" alt="" class="image">
                  <div class="blog-content-wrap">
                    <div class="category-tag">
                      <div class="category-title">Step 1</div>
                    </div>
                    <div class="blog-content">
                      <h3 class="heading-3">Click any of our login buttons</h3>
                      <p class="paragraph">You&#x27;ll be prompted to log in with google</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="column">
                <div class="blog-card">
                  <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea4ce52ce60e49559633d_login2.JPG" loading="lazy" sizes="(max-width: 479px) 78vw, (max-width: 767px) 82vw, (max-width: 991px) 76vw, 23vw" srcset="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea4ce52ce60e49559633d_login2-p-800.jpeg 800w, https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea4ce52ce60e49559633d_login2.JPG 890w" alt="" class="image">
                  <div class="blog-content-wrap">
                    <div class="category-tag">
                      <div class="category-title">Step 2</div>
                    </div>
                    <div class="blog-content">
                      <h3 class="heading-3">Log in with your Google Account</h3>
                      <p class="paragraph">Log in with your school email. This allows you to take full advantage of our GC sync feature</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="column">
                <div class="blog-card">
                  <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea50045656a0af3e870ac_login3.JPG" loading="lazy" sizes="(max-width: 479px) 78vw, (max-width: 767px) 82vw, (max-width: 991px) 76vw, 23vw" srcset="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea50045656a0af3e870ac_login3-p-500.jpeg 500w, https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea50045656a0af3e870ac_login3-p-800.jpeg 800w, https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60bea50045656a0af3e870ac_login3.JPG 895w" alt="" class="image">
                  <div class="blog-content-wrap">
                    <div class="category-tag">
                      <div class="category-title">Step 3</div>
                    </div>
                    <div class="blog-content">
                      <h3 class="heading-3">Confirm and you&#x27;re good to go!</h3>
                      <p class="paragraph">Your session is stored so that you don&#x27;t have to keep on logging in.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="section-content">
        ...
        <div class="container">
          ...
          <div class="blog-article-wrap">
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c02d014d19549d0e6e6563_intro1.JPG" loading="lazy" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 1</div>
                  </div>
            ...
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c02d0e3ee6a2f79d5eb4d5_createtask.JPG" loading="lazy" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 2</div>
                  </div>
            ...
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c02fb1e0d4854b24984d73_edittask.JPG" loading="lazy" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 3</div>
                  </div>
        ...
        <div class="container">
          ...
          <div class="blog-article-wrap">
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c04910f58fff47a7d2a5a4_labelsplus.JPG" loading="lazy" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 1</div>
                  </div>
            ...
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c04bfc10c3c83446d217a6_labels2.JPG" loading="lazy" sizes="(max-width: 479px) 83vw, (max-width: 767px) 87vw, (max-width: 991px) 85vw, 24vw" srcset="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c04bfc10c3c83446d217a6_labels2-p-500.jpeg 500w, https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c04bfc10c3c83446d217a6_labels2.JPG 516w" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 2</div>
                  </div>
            ...
            <div class="column">
              <div class="blog-card">
                <img src="https://uploads-ssl.webflow.com/60bdafd24f62e8078ac977ef/60c04893d4d340942f820ce7_labels1.JPG" loading="lazy" alt="" class="image">
                <div class="blog-content-wrap">
                  <div class="category-tag">
                    <div class="category-title">Step 3</div>
                  </div>
                  <div class="blog-content">
                    <h3 class="heading-3">All done!</h3>
                    <p class="paragraph">Labels could be seen on the top of every task title. It helps to keep track what you should be doing without filling up the title space.</p>
                  </div>
                </div>
              </div>
            </div>
